<div class="modal-dialog">
	<div class="modal-content">
		...
		<div class="modal-body">
			<form role="form" class="form-horizontal" action="<?= SITE_URL . '/publications/edit' ?>" method="post" name="edit" id="modal-form">
				...
				<div class="form-group">
					...
					<div class="col-xs-8">
						<input type="text" class="form-control" name="name" id="name" value="<?= $pub['name'] ?>" autofocus>
					</div>
				</div>
				<div class="form-group">
